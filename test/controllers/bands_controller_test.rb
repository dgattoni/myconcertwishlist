...
class BandsControllerTest < ActionController::TestCase
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post :create, band: { description: @band.description, fanlevel: @band.fanlevel, image: @band.image, name: @band.name }
    end
  ...
  test "should update band" do
    patch :update, id: @band, band: { description: @band.description, fanlevel: @band.fanlevel, image: @band.image, name: @band.name }
    assert_redirected_to band_path(assigns(:band))
  end
